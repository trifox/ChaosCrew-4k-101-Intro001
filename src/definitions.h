...
static DEVMODE screenSettings = { 
	...
	#include "sointu/song_000.h"

	#pragma data_seg(".4klangout")
	static float lpSoundBuffer[SU_LENGTH_IN_SAMPLES * 2];
...
//	#endif		
		...
		SU_SAMPLE_RATE*SU_SAMPLE_SIZE * 2, // bytes per sec
		SU_SAMPLE_SIZE * 2,             // block alignment;
	...
	{
		(LPSTR)lpSoundBuffer, SU_LENGTH_IN_SAMPLES * SU_SAMPLE_SIZE * 2, 0, 0, 0, 0, 0, 0
	};

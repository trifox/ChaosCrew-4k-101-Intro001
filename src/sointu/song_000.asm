...
su_render_sampleloop:                   ; loop through every sample in the row
            ...
            push    3		; Stack: VoicesRemain, Sample, Row, GlobalTick, RandSeed, edi, esi, ebp, esp, ebx, edx, ecx, eax, retaddr_su_render_song, OutputBufPtr 
...
; The simple implementation: each track triggers always the same voice
    ...
    mov     bl, 2                      ; MAX_TRACKS is always <= 32 so this is ok
...
su_patterns:
    ...
    db 69,1,1,1,60,1,1,1,69,1,1,1,69,1,1,1,60,1,1,1,69,1,1,1,60,1,1,1,60,1,1,1
    db 69,1,1,1,60,1,1,1,64,1,1,1,68,1,1,1,69,1,1,1,60,1,1,1,64,1,1,1,68,1,1,1
    db 57,1,1,1,56,1,1,1,57,1,1,1,57,1,1,1,56,1,1,1,57,1,1,1,56,1,1,1,56,1,1,1
    db 1,60,1,60,1,1,1,1,1,60,1,1,1,60,1,1,1,60,1,60,1,1,1,1,1,60,1,1,1,60,1,1
...
su_patch_opcodes:
    db 2,4,6,8,6,10,4,12,12,14,16,16,18,20,22,25,0,2,8,18,16,22,25,0,2,12,12,18,18,22,25,0
...
su_patch_operands:
    db 0,72,0,16,128,88,176,0,16,64,128,64,0,74,200,0,64,62,0,64,64,128,16,64,74,0,16,64,128,16,48,128,64,48,64,64,64,128,64,64,0,1,64,128,16,0,64,0,0,128,64,128,128,128,16,64,64,0,0,74,0,74,128,64,64,64,128,96,128,64,64,64,64,128,96,128,64,64,64,93
